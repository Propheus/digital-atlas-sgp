# Plexis SGP — Checkpoint v4.9.0

**Generated:** 2026-06-01T22:11:13  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 34 (in catalog) · **Features:** 1007 (931 with curated descriptions)  
**Files indexed:** 208 · **Total size:** 377.6 MB
...
| `hex/hex9_all_features.parquet` | 6.4 |
...
_Checkpoint manifest: `CHECKPOINT_v4.9.0.json`. Atlas-1 backup: `plexis-sgp-v4.9.0.tar.gz`._