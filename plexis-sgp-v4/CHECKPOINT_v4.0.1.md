# Plexis SGP — Checkpoint v4.0.1

**Generated:** 2026-04-25T05:10:15  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 31 (in catalog) · **Features:** 954 (878 with curated descriptions)  
**Files indexed:** 102 · **Total size:** 247.6 MB
...
|---|---|---|---|---|
| `hex/hex8_all_features.parquet` | hex8 | 1,191 × 102 | all | MASTER — all standalone layers joined per hex-8 |
...
| `hex/hex9_all_features.parquet` | hex9 | 7,318 × 106 | all | MASTER — all standalone layers joined per hex-9 |
...
| `hex/subzone_all_features.parquet` | subzone | 326 × 80 | all | MASTER — all standalone layers joined per subzone |
...
| `hex/hex9_all_features.parquet` | 2.6 |
...
_Checkpoint manifest: `CHECKPOINT_v4.0.1.json`. Atlas-1 backup: `plexis-sgp-v4.0.1.tar.gz`._