# Plexis SGP — Checkpoint v4.5.0

**Generated:** 2026-04-30T00:59:30  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 34 (in catalog) · **Features:** 1007 (931 with curated descriptions)  
**Files indexed:** 187 · **Total size:** 269.0 MB
...
| `hex/hex9_all_features.parquet` | 6.2 |
...
_Checkpoint manifest: `CHECKPOINT_v4.5.0.json`. Atlas-1 backup: `plexis-sgp-v4.5.0.tar.gz`._