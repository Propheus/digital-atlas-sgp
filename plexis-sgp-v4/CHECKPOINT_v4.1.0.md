# Plexis SGP — Checkpoint v4.1.0

**Generated:** 2026-04-29T11:05:55  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 34 (in catalog) · **Features:** 1007 (931 with curated descriptions)  
**Files indexed:** 138 · **Total size:** 260.0 MB
...
| `hex/hex9_all_features.parquet` | 3.4 |
...
_Checkpoint manifest: `CHECKPOINT_v4.1.0.json`. Atlas-1 backup: `plexis-sgp-v4.1.0.tar.gz`._