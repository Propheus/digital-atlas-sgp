# Plexis SGP — Checkpoint v4.4.0

**Generated:** 2026-04-30T00:55:17  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 34 (in catalog) · **Features:** 1007 (931 with curated descriptions)  
**Files indexed:** 183 · **Total size:** 268.3 MB
...
| `hex/hex9_all_features.parquet` | 6.0 |
...
| `hex/hex8_all_features.parquet` | 1.7 |
| `hex/hex9_roads.parquet` | 1.5 |
| `hex/hex9_roads_raw.parquet` | 1.5 |

---

_Checkpoint manifest: `CHECKPOINT_v4.4.0.json`. Atlas-1 backup: `plexis-sgp-v4.4.0.tar.gz`._