# Digital Atlas — Data Catalog (Plexis **v5.1.0**)
...
| **hex8** (H3 res-8, ~0.74 km²) | 1,191 | **703** | `hex/hex8_all_features.parquet` |
...
| **Git repo** | `github.com/Propheus/digital-atlas-sgp` → `plexis-sgp-v4/`, `explorer-app/` (LFS for parquet/geojson/csv) |
