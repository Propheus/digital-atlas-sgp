# Plexis SGP — Checkpoint v4.3.0

**Generated:** 2026-04-30T00:37:25  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 34 (in catalog) · **Features:** 1007 (931 with curated descriptions)  
**Files indexed:** 172 · **Total size:** 264.2 MB
...
| `hex/hex9_all_features.parquet` | 4.5 |
...
_Checkpoint manifest: `CHECKPOINT_v4.3.0.json`. Atlas-1 backup: `plexis-sgp-v4.3.0.tar.gz`._