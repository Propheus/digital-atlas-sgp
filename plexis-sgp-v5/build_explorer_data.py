...
DETAIL = {
 ...
 "Mobility pack (S11)": ["time_to_cbd_min","time_to_orchard_min",
    "time_to_jurong_east_min","pct_dest_within_45min","n_lines_to_cbd",
    "mrt_reach_eff_min","mrt_reach_mode","peak_wait_min","crowding_load_factor",
    "adq_default","adq_worst_factor","min15_score","linkway_len_m",
    "cycling_path_len_m","zone_type_broad"],
}
