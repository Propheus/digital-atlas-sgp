# Plexis SGP — Checkpoint v4.6.0

**Generated:** 2026-04-30T01:10:13  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 34 (in catalog) · **Features:** 1007 (931 with curated descriptions)  
**Files indexed:** 195 · **Total size:** 269.7 MB
...
| `hex/hex8_all_features.parquet` | 1.8 |
...
_Checkpoint manifest: `CHECKPOINT_v4.6.0.json`. Atlas-1 backup: `plexis-sgp-v4.6.0.tar.gz`._