# Plexis SGP — Checkpoint v4.0.0

**Generated:** 2026-04-25T04:40:48  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 24 (in catalog) · **Features:** 594 (529 with curated descriptions)  
**Files indexed:** 94 · **Total size:** 243.9 MB
...
| `boundaries/regions.geojson` | 1.2 |

---

_Checkpoint manifest: `CHECKPOINT_v4.0.0.json`. Atlas-1 backup: `plexis-sgp-v4.0.0.tar.gz`._