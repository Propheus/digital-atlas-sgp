...
|---|---|---|---|---|---|
| `cat_a` | object | category | 0.0 | 26 unique · `automated_kiosk` | Anchor category A (lift = how much B over-concentrates near A) |
| `cat_b` | object | category | 0.0 | 26 unique · `automated_kiosk` | Partner category B |
| `ci_hi` | float64 | ratio | 0.0 | 0.2224 → 4.322 (median 1.044) | Bootstrap 95% CI upper |
| `ci_lo` | float64 | ratio | 0.0 | 0.2067 → 3.809 (median 0.9664) | Bootstrap 95% CI lower (200 resamples of the A-set) |
| `lift` | float64 | ratio | 0.0 | 0.2143 → 4.066 (median 1.004) | mean count of B within 400 m of A-places ÷ category-blind base over all places. >1 = B seeks A (bar→bar 3.0); <1 = avoidance (industrial→residential 0.50) |
...
| Column | dtype | Units | Null % | Range / sample | Description |
|---|---|---|---|---|---|
| `access_vuln_penalty` | float64 | points | 57.8 | 0 → 0.25 (median 0) | Access-vulnerability penalty |
| `access_vuln_share` | float64 | ratio | 57.8 | 0 → 1 (median 0.1926) | Access-vulnerable share |
| `accessibility_composite` | float64 | 0-1 | 0.0 | 0 → 0.957 (median 0.287) | Composite access score across transit + walk + road reach |
| `adq_availability_v2` | float64 | 0-100 | 59.2 | 0.0606 → 1 (median 0.2491) | Transit availability composite |
| `adq_core` | float64 | 0-100 | 59.2 | 0.1839 → 1 (median 0.4482) | Adequacy core (pre-vulnerability) |
| `adq_core_elderly` | float64 | 0-100 | 59.2 | 0.1634 → 1 (median 0.3772) | Adequacy core, elderly |
| `adq_core_family` | float64 | 0-100 | 59.2 | 0.1967 → 1 (median 0.4576) | Adequacy core, family |
| `adq_core_workers` | float64 | 0-100 | 59.2 | 0.1938 → 1 (median 0.5129) | Adequacy core, workers |
| `adq_default` | float64 | 0-100 | 59.2 | 0.0677 → 1 (median 0.4017) | Transport adequacy v3 (default profile, 0-100) |
| `adq_default_elderly` | float64 | 0-100 | 59.2 | 0.0677 → 1 (median 0.4873) | Adequacy, elderly profile |
| `adq_default_family` | float64 | 0-100 | 59.2 | 0.0606 → 1 (median 0.4607) | Adequacy, family profile |
| `adq_default_workers` | float64 | 0-100 | 59.2 | 0.0606 → 1 (median 0.3122) | Adequacy, workers profile |
| `adq_f_accessibility` | float64 | 0-100 | 59.2 | 0.2829 → 1 (median 0.4828) | Adequacy v3 factor score: composite access (mobility-v2 model) |
| `adq_f_children_gap` | float64 | 0-100 | 59.2 | 0 → 0.8001 (median 0) | Adequacy v3 factor score: child-population service gap (mobility-v2 model) |
| `adq_f_connectivity` | float64 | 0-100 | 59.2 | 0 → 1 (median 0.4298) | Adequacy v3 factor score: network connectivity (mobility-v2 model) |
| `adq_f_distance` | float64 | 0-100 | 59.2 | 0.004667 → 1 (median 0.145) | Adequacy v3 factor score: distance to transit (mobility-v2 model) |
| `adq_f_dorm_gap` | float64 | 0-100 | 59.2 | 0 → 0.99 (median 0) | Adequacy v3 factor score: dorm-worker service gap (mobility-v2 model) |
| `adq_f_elderly_gap` | float64 | 0-100 | 59.2 | 0 → 0.9814 (median 0.2072) | Adequacy v3 factor score: elderly service gap (mobility-v2 model) |
| `adq_f_fdw_gap` | float64 | 0-100 | 59.2 | 0 → 0.7624 (median 0.0623) | Adequacy v3 factor score: FDW service gap (mobility-v2 model) |
| `adq_f_last_mile` | float64 | 0-100 | 59.2 | 0.1719 → 1 (median 0.578) | Adequacy v3 factor score: last-mile friction (mobility-v2 model) |
| `adq_f_line_pressure` | float64 | 0-100 | 59.2 | 0 → 1 (median 0) | Adequacy v3 factor score: line crowding pressure (mobility-v2 model) |
| `adq_f_low_frequency` | float64 | 0-100 | 59.2 | 0 → 1 (median 0.146) | Adequacy v3 factor score: service frequency shortfall (mobility-v2 model) |
| `adq_f_low_income_gap` | float64 | 0-100 | 59.2 | 0 → 0.5188 (median 0.0935) | Adequacy v3 factor score: low-income service gap (mobility-v2 model) |
| `adq_f_reach_gap` | float64 | 0-100 | 59.2 | 0 → 1 (median 0.0899) | Adequacy v3 factor score: destination reach shortfall (mobility-v2 model) |
| `adq_gap_core` | float64 | 0-100 | 59.2 | 0.1614 → 0.95 (median 0.3764) | Adequacy gap (core) |
| `adq_gap_default` | float64 | 0-100 | 59.2 | 0.1409 → 0.9 (median 0.3646) | Adequacy gap (default profile) |
| `adq_gap_equity_max` | float64 | 0-100 | 59.2 | 0 → 0.99 (median 0.3112) | Worst per-profile equity gap |
...
| `adq_v2` | float64 | 0-100 | 59.2 | 0.0677 → 1 (median 0.393) | Adequacy v2 (availability-floored legacy) |
| `adq_worst_factor` | object | category | 0.0 | 10 unique · `f_accessibility` | Name of the worst adequacy factor |
| `adq_worst_factor_value` | float64 | 0-100 | 59.2 | 0.1084 → 1 (median 0.5462) | Score of the worst adequacy factor |
...
| `cap_beauty_personal` | float64 | outlet-equivalents | 0.0 | 0 → 3.938 (median 0.3151) | Huff capture for a NEW beauty_personal outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_best_category` | object | category | 0.0 | 10 unique · `cafe_coffee` | Category with the highest capture at this hex |
| `cap_cafe_coffee` | float64 | outlet-equivalents | 0.0 | 0 → 3.924 (median 0.2396) | Huff capture for a NEW cafe_coffee outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_convenience` | float64 | outlet-equivalents | 0.0 | 0 → 4.013 (median 0.1262) | Huff capture for a NEW convenience outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_education` | float64 | outlet-equivalents | 0.0 | 0 → 2.492 (median 0.2397) | Huff capture for a NEW education outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_fast_food` | float64 | outlet-equivalents | 0.0 | 0 → 2.147 (median 0.1525) | Huff capture for a NEW fast_food outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_fitness_recreation` | float64 | outlet-equivalents | 0.0 | 0 → 3.57 (median 0.1917) | Huff capture for a NEW fitness_recreation outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_hawker` | float64 | outlet-equivalents | 0.0 | 0 → 4.963 (median 0.1857) | Huff capture for a NEW hawker outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_health_medical` | float64 | outlet-equivalents | 0.0 | 0 → 4.445 (median 0.2512) | Huff capture for a NEW health_medical outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_restaurant` | float64 | outlet-equivalents | 0.0 | 0 → 3.773 (median 0.3974) | Huff capture for a NEW restaurant outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_shopping_retail` | float64 | outlet-equivalents | 0.0 | 0 → 4.226 (median 0.4368) | Huff capture for a NEW shopping_retail outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_supermarket` | float64 | outlet-equivalents | 0.0 | 0 → 3.206 (median 0.1475) | Huff capture for a NEW supermarket outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_total` | float64 | outlet-equivalents | 0.0 | 0 → 38.41 (median 2.765) | Sum of per-category Huff capture: demand (outlet-equivalents) a NEW outlet at the best hex9 in this hex would win vs existing competition. λ ASSUMED (500/700/1000/1500m priors; not identifiable from data — rankings λ-robust ρ≥0.83) |
...
| `colo_fit_beauty_personal` | float64 | log-lift | 0.0 | -0.4114 → 0.547 (median 0.2233) | Co-location mix-match for beauty_personal: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_cafe_coffee` | float64 | log-lift | 0.0 | -0.3437 → 0.1978 (median 0.1095) | Co-location mix-match for cafe_coffee: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_convenience` | float64 | log-lift | 0.0 | -0.3274 → 0.187 (median 0) | Co-location mix-match for convenience: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_education` | float64 | log-lift | 0.0 | -0.5625 → 0.2059 (median 0) | Co-location mix-match for education: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_fast_food` | float64 | log-lift | 0.0 | -0.7249 → 0.266 (median 0.0337) | Co-location mix-match for fast_food: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_fitness_recreation` | float64 | log-lift | 0.0 | -0.5516 → 0.1304 (median 0) | Co-location mix-match for fitness_recreation: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_hawker` | float64 | log-lift | 0.0 | -0.5932 → 0.2667 (median 0) | Co-location mix-match for hawker: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_health_medical` | float64 | log-lift | 0.0 | -0.4839 → 0.2461 (median 0.084) | Co-location mix-match for health_medical: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_restaurant` | float64 | log-lift | 0.0 | -0.1142 → 0.5724 (median 0.2163) | Co-location mix-match for restaurant: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_shopping_retail` | float64 | log-lift | 0.0 | 0 → 0.4489 (median 0.1561) | Co-location mix-match for shopping_retail: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_supermarket` | float64 | log-lift | 0.0 | -0.3589 → 0.1712 (median 0) | Co-location mix-match for supermarket: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
...
| `crowd_equity_penalty` | float64 | points | 57.8 | 0 → 0.2338 (median 0) | Crowding equity penalty |
| `crowd_sensitive_share` | float64 | ratio | 57.8 | 0 → 0.55 (median 0.3139) | Crowding-sensitive share |
...
| `format_fit_score` | float64 | 0-100 | 0.0 | 0 → 88 (median 0) | Retail format-fit (nous V4): score100(minmax(walkability_score) * minmax(retail_footfall_score) * minmax(colo_fit_cat)). Footfall term now the V4 decontaminated retail_footfall_score, NOT vis_exit_footfall. |
...
| `industrial_adjacency_score` | float64 | 0-1 | 0.0 | 0 → 1 (median 0) | Physical-industry adjacency (nous V4): saturating ramp on bldg_industrial_count (0 below ~6 bldgs, >0.6 at >=10) + confirmed-industrial zone floor. Keyed on PHYSICAL buildings, NOT business zoning — corr(bldg)=0.75 > corr(lu_business)=0.46. Heartland<0.3, CBD office<0.3. |
| `insurance_accumulation_band` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `insurance_risk_score` | int64 |  | 0.0 | 0 → 100 (median 17) |  |
...
| `max1_pc_cat_business_office` | float64 |  | 0.0 | 0 → 755 (median 10) | Max over ring-1 neighbours of: Place count in cell: business office category (24-cat taxonomy) |
| `max1_pc_cat_cafe_coffee` | float64 |  | 0.0 | 0 → 226 (median 2) | Max over ring-1 neighbours of: Place count in cell: cafe coffee category (24-cat taxonomy) |
| `max1_pc_cat_education` | float64 |  | 0.0 | 0 → 172 (median 2) | Max over ring-1 neighbours of: Place count in cell: education category (24-cat taxonomy) |
| `max1_pc_cat_hawker` | float64 |  | 0.0 | 0 → 248 (median 1) | Max over ring-1 neighbours of: Place count in cell: hawker category (24-cat taxonomy) |
| `max1_pc_cat_health_medical` | float64 |  | 0.0 | 0 → 500 (median 1) | Max over ring-1 neighbours of: Place count in cell: health medical category (24-cat taxonomy) |
| `max1_pc_cat_industrial_mfg` | float64 |  | 0.0 | 0 → 441 (median 9) | Max over ring-1 neighbours of: Place count in cell: industrial mfg category (24-cat taxonomy) |
| `max1_pc_cat_residential` | float64 |  | 0.0 | 0 → 153 (median 3) | Max over ring-1 neighbours of: Place count in cell: residential category (24-cat taxonomy) |
| `max1_pc_cat_restaurant` | float64 |  | 0.0 | 0 → 621 (median 4) | Max over ring-1 neighbours of: Place count in cell: restaurant category (24-cat taxonomy) |
| `max1_pc_cat_shopping_retail` | float64 |  | 0.0 | 0 → 851 (median 6) | Max over ring-1 neighbours of: Place count in cell: shopping retail category (24-cat taxonomy) |
...
| `max1_pc_unique_brands` | float64 |  | 0.0 | 0 → 126 (median 5) | Max over ring-1 neighbours of: Distinct retail/F&B brands present — chain richness |
...
| `max2_pc_cat_business_office` | float64 |  | 0.0 | 0 → 755 (median 27) | Max over ring-2 neighbours of: Place count in cell: business office category (24-cat taxonomy) |
| `max2_pc_cat_cafe_coffee` | float64 |  | 0.0 | 0 → 226 (median 9) | Max over ring-2 neighbours of: Place count in cell: cafe coffee category (24-cat taxonomy) |
| `max2_pc_cat_education` | float64 |  | 0.0 | 0 → 172 (median 15) | Max over ring-2 neighbours of: Place count in cell: education category (24-cat taxonomy) |
| `max2_pc_cat_hawker` | float64 |  | 0.0 | 0 → 248 (median 10) | Max over ring-2 neighbours of: Place count in cell: hawker category (24-cat taxonomy) |
| `max2_pc_cat_health_medical` | float64 |  | 0.0 | 0 → 500 (median 7) | Max over ring-2 neighbours of: Place count in cell: health medical category (24-cat taxonomy) |
| `max2_pc_cat_industrial_mfg` | float64 |  | 0.0 | 0 → 441 (median 26) | Max over ring-2 neighbours of: Place count in cell: industrial mfg category (24-cat taxonomy) |
| `max2_pc_cat_residential` | float64 |  | 0.0 | 0 → 153 (median 20) | Max over ring-2 neighbours of: Place count in cell: residential category (24-cat taxonomy) |
| `max2_pc_cat_restaurant` | float64 |  | 0.0 | 0 → 621 (median 15) | Max over ring-2 neighbours of: Place count in cell: restaurant category (24-cat taxonomy) |
| `max2_pc_cat_shopping_retail` | float64 |  | 0.0 | 0 → 851 (median 19) | Max over ring-2 neighbours of: Place count in cell: shopping retail category (24-cat taxonomy) |
...
| `max2_pc_unique_brands` | float64 |  | 0.0 | 0 → 126 (median 18) | Max over ring-2 neighbours of: Distinct retail/F&B brands present — chain richness |
...
| `mg_bakery_anchor_strength` | float64 |  | 0.0 | 0 → 1061 (median 0) | Magnet model: strength of the biggest bakery anchor place nearby |
...
| `mg_bakery_support_400m` | float64 |  | 0.0 | 0 → 156.3 (median 0) | Magnet model: complementary-category support density within 400 m for bakery (demand context, not supply) |
| `mg_bar_nightlife_anchor_strength` | float64 |  | 0.0 | 0 → 190.1 (median 0) | Magnet model: strength of the biggest bar nightlife anchor place nearby |
| `mg_bar_nightlife_pressure_400m` | float64 |  | 0.0 | 0 → 18.89 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for bar nightlife |
| `mg_bar_nightlife_support_400m` | float64 |  | 0.0 | 0 → 80.75 (median 0) | Magnet model: complementary-category support density within 400 m for bar nightlife (demand context, not supply) |
| `mg_beauty_personal_anchor_strength` | float64 |  | 0.0 | 0 → 877.9 (median 0) | Magnet model: strength of the biggest beauty personal anchor place nearby |
...
| `mg_beauty_personal_support_400m` | float64 |  | 0.0 | 0 → 170.2 (median 0) | Magnet model: complementary-category support density within 400 m for beauty personal (demand context, not supply) |
| `mg_business_office_anchor_strength` | float64 |  | 0.0 | 0 → 247.8 (median 0) | Magnet model: strength of the biggest business office anchor place nearby |
| `mg_business_office_pressure_400m` | float64 |  | 0.0 | 0 → 170.4 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for business office |
| `mg_business_office_support_400m` | float64 |  | 0.0 | 0 → 222.3 (median 0) | Magnet model: complementary-category support density within 400 m for business office (demand context, not supply) |
| `mg_cafe_coffee_anchor_strength` | float64 |  | 0.0 | 0 → 1124 (median 0) | Magnet model: strength of the biggest cafe coffee anchor place nearby |
| `mg_cafe_coffee_pressure_400m` | float64 |  | 0.0 | 0 → 32.91 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for cafe coffee |
| `mg_cafe_coffee_support_400m` | float64 |  | 0.0 | 0 → 153.6 (median 0) | Magnet model: complementary-category support density within 400 m for cafe coffee (demand context, not supply) |
| `mg_convenience_anchor_strength` | float64 |  | 0.0 | 0 → 62.34 (median 0) | Magnet model: strength of the biggest convenience anchor place nearby |
| `mg_convenience_pressure_400m` | float64 |  | 0.0 | 0 → 23.65 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for convenience |
| `mg_convenience_support_400m` | float64 |  | 0.0 | 0 → 22.59 (median 0) | Magnet model: complementary-category support density within 400 m for convenience (demand context, not supply) |
| `mg_education_anchor_strength` | float64 |  | 0.0 | 0 → 30.16 (median 0) | Magnet model: strength of the biggest education anchor place nearby |
| `mg_education_pressure_400m` | float64 |  | 0.0 | 0 → 54.29 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for education |
| `mg_education_support_400m` | float64 |  | 0.0 | 0 → 26.68 (median 0) | Magnet model: complementary-category support density within 400 m for education (demand context, not supply) |
| `mg_entertainment_culture_anchor_strength` | float64 |  | 0.0 | 0 → 757 (median 0) | Magnet model: strength of the biggest entertainment culture anchor place nearby |
| `mg_entertainment_culture_pressure_400m` | float64 |  | 0.0 | 0 → 16.71 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for entertainment culture |
| `mg_entertainment_culture_support_400m` | float64 |  | 0.0 | 0 → 84.27 (median 0) | Magnet model: complementary-category support density within 400 m for entertainment culture (demand context, not supply) |
| `mg_fast_food_anchor_strength` | float64 |  | 0.0 | 0 → 910 (median 0) | Magnet model: strength of the biggest fast food anchor place nearby |
...
| `mg_fitness_recreation_anchor_strength` | float64 |  | 0.0 | 0 → 762.9 (median 0) | Magnet model: strength of the biggest fitness recreation anchor place nearby |
| `mg_fitness_recreation_pressure_400m` | float64 |  | 0.0 | 0 → 16.8 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for fitness recreation |
| `mg_fitness_recreation_support_400m` | float64 |  | 0.0 | 0 → 110.3 (median 0) | Magnet model: complementary-category support density within 400 m for fitness recreation (demand context, not supply) |
...
| `mg_government_public_pressure_400m` | float64 |  | 0.0 | 0 → 11.55 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for government public |
| `mg_government_public_support_400m` | float64 |  | 0.0 | 0 → 159.3 (median 0) | Magnet model: complementary-category support density within 400 m for government public (demand context, not supply) |
| `mg_hawker_anchor_strength` | float64 |  | 0.0 | 0 → 67.72 (median 0) | Magnet model: strength of the biggest hawker anchor place nearby |
| `mg_hawker_pressure_400m` | float64 |  | 0.0 | 0 → 106.5 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for hawker |
| `mg_hawker_support_400m` | float64 |  | 0.0 | 0 → 30.82 (median 0) | Magnet model: complementary-category support density within 400 m for hawker (demand context, not supply) |
...
| `mg_health_medical_pressure_400m` | float64 |  | 0.0 | 0 → 120.4 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for health medical |
| `mg_health_medical_support_400m` | float64 |  | 0.0 | 0 → 116.1 (median 0) | Magnet model: complementary-category support density within 400 m for health medical (demand context, not supply) |
| `mg_hotel_hospitality_anchor_strength` | float64 |  | 0.0 | 0 → 777.1 (median 0) | Magnet model: strength of the biggest hotel hospitality anchor place nearby |
...
| `mg_hotel_hospitality_support_400m` | float64 |  | 0.0 | 0 → 88.25 (median 0) | Magnet model: complementary-category support density within 400 m for hotel hospitality (demand context, not supply) |
| `mg_industrial_mfg_anchor_strength` | float64 |  | 0.0 | 0 → 247.9 (median 0) | Magnet model: strength of the biggest industrial mfg anchor place nearby |
| `mg_industrial_mfg_pressure_400m` | float64 |  | 0.0 | 0 → 107.8 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for industrial mfg |
| `mg_industrial_mfg_support_400m` | float64 |  | 0.0 | 0 → 311.6 (median 0) | Magnet model: complementary-category support density within 400 m for industrial mfg (demand context, not supply) |
...
| `mg_park_open_pressure_400m` | float64 |  | 0.0 | 0 → 7.37 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for park open |
...
| `mg_religious_worship_anchor_strength` | float64 |  | 0.0 | 0 → 22.46 (median 0) | Magnet model: strength of the biggest religious worship anchor place nearby |
| `mg_religious_worship_pressure_400m` | float64 |  | 0.0 | 0 → 13.32 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for religious worship |
| `mg_religious_worship_support_400m` | float64 |  | 0.0 | 0 → 19.49 (median 0) | Magnet model: complementary-category support density within 400 m for religious worship (demand context, not supply) |
| `mg_residential_anchor_strength` | float64 |  | 0.0 | 0 → 494.5 (median 0) | Magnet model: strength of the biggest residential anchor place nearby |
| `mg_residential_pressure_400m` | float64 |  | 0.0 | 0 → 17.74 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for residential |
| `mg_residential_support_400m` | float64 |  | 0.0 | 0 → 33.6 (median 0) | Magnet model: complementary-category support density within 400 m for residential (demand context, not supply) |
| `mg_restaurant_anchor_strength` | float64 |  | 0.0 | 0 → 988.9 (median 0) | Magnet model: strength of the biggest restaurant anchor place nearby |
| `mg_restaurant_pressure_400m` | float64 |  | 0.0 | 0 → 117.5 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for restaurant |
| `mg_restaurant_support_400m` | float64 |  | 0.0 | 0 → 94.87 (median 0) | Magnet model: complementary-category support density within 400 m for restaurant (demand context, not supply) |
| `mg_services_anchor_strength` | float64 |  | 0.0 | 0 → 934 (median 0) | Magnet model: strength of the biggest services anchor place nearby |
| `mg_services_pressure_400m` | float64 |  | 0.0 | 0 → 129.3 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for services |
| `mg_services_support_400m` | float64 |  | 0.0 | 0 → 209.3 (median 0) | Magnet model: complementary-category support density within 400 m for services (demand context, not supply) |
| `mg_shopping_retail_anchor_strength` | float64 |  | 0.0 | 0 → 1008 (median 0) | Magnet model: strength of the biggest shopping retail anchor place nearby |
| `mg_shopping_retail_pressure_400m` | float64 |  | 0.0 | 0 → 101.3 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for shopping retail |
| `mg_shopping_retail_support_400m` | float64 |  | 0.0 | 0 → 132.8 (median 0) | Magnet model: complementary-category support density within 400 m for shopping retail (demand context, not supply) |
...
| `mg_supermarket_pressure_400m` | float64 |  | 0.0 | 0 → 27.31 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for supermarket |
| `mg_supermarket_support_400m` | float64 |  | 0.0 | 0 → 120.3 (median 0) | Magnet model: complementary-category support density within 400 m for supermarket (demand context, not supply) |
| `mg_transportation_anchor_strength` | float64 |  | 0.0 | 0 → 955.4 (median 0) | Magnet model: strength of the biggest transportation anchor place nearby |
| `mg_transportation_pressure_400m` | float64 |  | 0.0 | 0 → 16.95 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for transportation |
| `mg_transportation_support_400m` | float64 |  | 0.0 | 0 → 201.8 (median 0) | Magnet model: complementary-category support density within 400 m for transportation (demand context, not supply) |
...
| `mobility_access_score` | int64 |  | 0.0 | 0 → 100 (median 24) |  |
| `mobility_crowding_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `mobility_desert_priority` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `mobility_firstlast_gap_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `mobility_parking_stress` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `mobility_ridehail_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `mobility_tod_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `modal_split_proxy` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
...
| `pc_cat_automated_kiosk` | float64 |  | 0.0 | 0 → 23 (median 0) | Place count in cell: automated kiosk category (24-cat taxonomy) |
| `pc_cat_bakery` | float64 |  | 0.0 | 0 → 45 (median 0) | Place count in cell: bakery category (24-cat taxonomy) |
| `pc_cat_bar_nightlife` | float64 |  | 0.0 | 0 → 100 (median 0) | Place count in cell: bar nightlife category (24-cat taxonomy) |
| `pc_cat_beauty_personal` | float64 |  | 0.0 | 0 → 371 (median 0) | Place count in cell: beauty personal category (24-cat taxonomy) |
| `pc_cat_business_office` | float64 |  | 0.0 | 0 → 755 (median 1) | Place count in cell: business office category (24-cat taxonomy) |
| `pc_cat_cafe_coffee` | float64 |  | 0.0 | 0 → 226 (median 0) | Place count in cell: cafe coffee category (24-cat taxonomy) |
| `pc_cat_convenience` | float64 |  | 0.0 | 0 → 43 (median 0) | Place count in cell: convenience category (24-cat taxonomy) |
| `pc_cat_education` | float64 |  | 0.0 | 0 → 172 (median 0) | Place count in cell: education category (24-cat taxonomy) |
| `pc_cat_entertainment_culture` | float64 |  | 0.0 | 0 → 104 (median 0) | Place count in cell: entertainment culture category (24-cat taxonomy) |
| `pc_cat_fast_food` | float64 |  | 0.0 | 0 → 24 (median 0) | Place count in cell: fast food category (24-cat taxonomy) |
| `pc_cat_financial_services` | float64 |  | 0.0 | 0 → 295 (median 0) | Place count in cell: financial services category (24-cat taxonomy) |
| `pc_cat_fitness_recreation` | float64 |  | 0.0 | 0 → 94 (median 0) | Place count in cell: fitness recreation category (24-cat taxonomy) |
| `pc_cat_government_public` | float64 |  | 0.0 | 0 → 52 (median 0) | Place count in cell: government public category (24-cat taxonomy) |
| `pc_cat_hawker` | float64 |  | 0.0 | 0 → 248 (median 0) | Place count in cell: hawker category (24-cat taxonomy) |
| `pc_cat_health_medical` | float64 |  | 0.0 | 0 → 500 (median 0) | Place count in cell: health medical category (24-cat taxonomy) |
| `pc_cat_hotel_hospitality` | float64 |  | 0.0 | 0 → 67 (median 0) | Place count in cell: hotel hospitality category (24-cat taxonomy) |
| `pc_cat_industrial_mfg` | float64 |  | 0.0 | 0 → 441 (median 1) | Place count in cell: industrial mfg category (24-cat taxonomy) |
| `pc_cat_other_uncategorized` | float64 |  | 0.0 | 0 → 90 (median 0) | Place count in cell: other uncategorized category (24-cat taxonomy) |
| `pc_cat_park_open` | float64 |  | 0.0 | 0 → 36 (median 0) | Place count in cell: park open category (24-cat taxonomy) |
| `pc_cat_religious_worship` | float64 |  | 0.0 | 0 → 57 (median 0) | Place count in cell: religious worship category (24-cat taxonomy) |
| `pc_cat_residential` | float64 |  | 0.0 | 0 → 153 (median 0) | Place count in cell: residential category (24-cat taxonomy) |
| `pc_cat_restaurant` | float64 |  | 0.0 | 0 → 621 (median 0) | Place count in cell: restaurant category (24-cat taxonomy) |
| `pc_cat_services` | float64 |  | 0.0 | 0 → 831 (median 0) | Place count in cell: services category (24-cat taxonomy) |
| `pc_cat_shopping_retail` | float64 |  | 0.0 | 0 → 851 (median 0) | Place count in cell: shopping retail category (24-cat taxonomy) |
| `pc_cat_supermarket` | float64 |  | 0.0 | 0 → 80 (median 0) | Place count in cell: supermarket category (24-cat taxonomy) |
| `pc_cat_transportation` | float64 |  | 0.0 | 0 → 153 (median 1) | Place count in cell: transportation category (24-cat taxonomy) |
| `pc_diversity` | float64 | 0-1 | 0.0 | 0 → 2.953 (median 1.386) | Category entropy of the place mix — high = mixed-use |
| `pc_dominant_category` | object | category | 0.0 | 25 unique · `none` | Most common place category in cell |
...
| `pc_unique_brands` | float64 | count | 0.0 | 0 → 414 (median 0) | Distinct retail/F&B brands present — chain richness |
...
| `pw1_pc_cat_business_office` | float64 |  | 0.0 | 0 → 619.2 (median 1.283) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: business office category (24-cat taxonomy) |
| `pw1_pc_cat_cafe_coffee` | float64 |  | 0.0 | 0 → 170.7 (median 0.256) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: cafe coffee category (24-cat taxonomy) |
| `pw1_pc_cat_education` | float64 |  | 0.0 | 0 → 118.8 (median 0.5) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: education category (24-cat taxonomy) |
| `pw1_pc_cat_hawker` | float64 |  | 0.0 | 0 → 172.6 (median 0) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: hawker category (24-cat taxonomy) |
| `pw1_pc_cat_health_medical` | float64 |  | 0.0 | 0 → 172.3 (median 0) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: health medical category (24-cat taxonomy) |
| `pw1_pc_cat_industrial_mfg` | float64 |  | 0.0 | 0 → 255 (median 1) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: industrial mfg category (24-cat taxonomy) |
| `pw1_pc_cat_residential` | float64 |  | 0.0 | 0 → 130.3 (median 0.667) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: residential category (24-cat taxonomy) |
| `pw1_pc_cat_restaurant` | float64 |  | 0.0 | 0 → 458.4 (median 1) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: restaurant category (24-cat taxonomy) |
| `pw1_pc_cat_shopping_retail` | float64 |  | 0.0 | 0 → 291.6 (median 0.701) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: shopping retail category (24-cat taxonomy) |
...
| `pw2_pc_cat_business_office` | float64 |  | 0.0 | 0 → 484 (median 6.122) | Proximity-weighted ring-2 aggregate of: Place count in cell: business office category (24-cat taxonomy) |
| `pw2_pc_cat_cafe_coffee` | float64 |  | 0.0 | 0 → 141 (median 4.382) | Proximity-weighted ring-2 aggregate of: Place count in cell: cafe coffee category (24-cat taxonomy) |
| `pw2_pc_cat_education` | float64 |  | 0.0 | 0 → 102.4 (median 7.887) | Proximity-weighted ring-2 aggregate of: Place count in cell: education category (24-cat taxonomy) |
| `pw2_pc_cat_hawker` | float64 |  | 0.0 | 0 → 113.2 (median 3.435) | Proximity-weighted ring-2 aggregate of: Place count in cell: hawker category (24-cat taxonomy) |
| `pw2_pc_cat_health_medical` | float64 |  | 0.0 | 0 → 147.6 (median 3.562) | Proximity-weighted ring-2 aggregate of: Place count in cell: health medical category (24-cat taxonomy) |
| `pw2_pc_cat_industrial_mfg` | float64 |  | 0.0 | 0 → 213 (median 5.503) | Proximity-weighted ring-2 aggregate of: Place count in cell: industrial mfg category (24-cat taxonomy) |
| `pw2_pc_cat_residential` | float64 |  | 0.0 | 0 → 121.3 (median 14.74) | Proximity-weighted ring-2 aggregate of: Place count in cell: residential category (24-cat taxonomy) |
| `pw2_pc_cat_restaurant` | float64 |  | 0.0 | 0 → 366.6 (median 6.846) | Proximity-weighted ring-2 aggregate of: Place count in cell: restaurant category (24-cat taxonomy) |
| `pw2_pc_cat_shopping_retail` | float64 |  | 0.0 | 0 → 251.1 (median 6.941) | Proximity-weighted ring-2 aggregate of: Place count in cell: shopping retail category (24-cat taxonomy) |
...
| `re_collateral_score` | int64 |  | 0.0 | 0 → 100 (median 27) |  |
| `re_enbloc_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `re_feasibility_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `re_lease_decay_penalty` | int64 |  | 0.0 | 0 → 100 (median 100) |  |
| `re_livability_score` | int64 |  | 0.0 | 0 → 100 (median 25) |  |
| `re_momentum_score` | int64 |  | 0.0 | 0 → 100 (median 10) |  |
| `re_yield_proxy` | float64 |  | 0.0 | 0 → 8.174 (median 0.0006) |  |
| `rent_confidence` | object | category | 0.0 | 4 unique · `na` | Retail-rent estimate confidence (nous V4): high (commercial_intensity>0.4 & footfall>0) | medium | low | na. |
| `rent_demand_tier` | int64 |  | 0.0 | 0 → 100 (median 71) |  |
| `rent_hdb_4r_est_pm` | float64 |  | 71.3 | 2634 → 5080 (median 3090) |  |
| `rent_hdb_est_psf` | float64 |  | 71.3 | 2.718 → 5.243 (median 3.189) |  |
| `rent_occ_cost_psf` | float64 |  | 47.1 | 2.02 → 8.174 (median 4.41) |  |
| `rent_occ_cost_source` | object |  | 0.0 | 3 unique · `none` |  |
...
| `risk_auto_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `risk_bi_failure_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `risk_coastal_proxy` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `risk_collateral_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `risk_fire_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `risk_health_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `risk_nuisance_score` | int64 |  | 0.0 | 0 → 100 (median 3) |  |
...
| `roi_cap_per_rent_cafe_coffee` | float64 | ratio | 47.5 | 0.0019 → 1.136 (median 0.22) | cap_cafe_coffee / rent_resi_psf_med — opportunity per occupancy-cost proxy (rank heuristic). NaN where no rent |
| `roi_cap_per_rent_restaurant` | float64 | ratio | 47.5 | 0.0012 → 1.123 (median 0.2533) | cap_restaurant / rent_resi_psf_med — opportunity per occupancy-cost proxy (rank heuristic). NaN where no rent |
| `roi_cap_per_rent_shopping_retail` | float64 | ratio | 47.5 | 0.0023 → 1.258 (median 0.2677) | cap_shopping_retail / rent_resi_psf_med — opportunity per occupancy-cost proxy (rank heuristic). NaN where no rent |
| `roi_cap_per_rent_supermarket` | float64 | ratio | 47.5 | 0.0006 → 0.9534 (median 0.1871) | cap_supermarket / rent_resi_psf_med — opportunity per occupancy-cost proxy (rank heuristic). NaN where no rent |
| `roi_cap_per_rent_total` | float64 | ratio | 47.5 | 0.0287 → 11.43 (median 2.304) | cap_total / rent_resi_psf_med — opportunity per occupancy-cost proxy (rank heuristic). NaN where no rent |
...
| `transport_subtype` | object | category | 0.0 | 3 unique · `transport_terminal` | Subtype for dominant_use='transport' (nous V4): transport_terminal (lu_transport_pct>=0.8 — non-leasable port/airside/depot) vs transport_transit (MRT/bus frontage, leasable) vs not_transport. |
| `utility_diurnal_swing` | int64 |  | 0.0 | -100 → 500 (median 0) |  |
| `utility_equity_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `utility_ev_gap_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `utility_load_growth_score` | int64 |  | 0.0 | 0 → 100 (median 1) |  |
| `utility_load_score` | int64 |  | 0.0 | 0 → 100 (median 1) |  |
| `utility_resilience_score` | int64 |  | 0.0 | 0 → 100 (median 18) |  |
| `utility_waste_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
| `utility_water_score` | int64 |  | 0.0 | 0 → 100 (median 0) |  |
...
| `vulnerability_penalty` | float64 | points | 57.8 | 0 → 0 (median 0) | Adequacy penalty from vulnerability double-threshold |
| `vulnerability_share` | float64 | ratio | 57.8 | 0 → 0.55 (median 0.3437) | Vulnerable-population share (adequacy v3 multiplier input) |
...
| `zone_type` | object | category | 0.0 | 12 unique · `transport_terminal` | URA zone type of the hex (PA→SZ→hex8 propagated) |
| `zone_type_broad` | object | category | 0.0 | 9 unique · `transport_terminal` | Broad zone class (residential/industrial/airport/nature/islands/future) — the NA-masking rule |
...
| `cap_beauty_personal` | float64 | outlet-equivalents | 0.0 | 0 → 3.938 (median 0.3325) | Huff capture for a NEW beauty_personal outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_best_category` | object | category | 0.0 | 11 unique · `cafe_coffee` | Category with the highest capture at this hex |
| `cap_cafe_coffee` | float64 | outlet-equivalents | 0.0 | 0 → 3.924 (median 0.2473) | Huff capture for a NEW cafe_coffee outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_convenience` | float64 | outlet-equivalents | 0.0 | 0 → 4.013 (median 0.1566) | Huff capture for a NEW convenience outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_education` | float64 | outlet-equivalents | 0.0 | 0 → 2.492 (median 0.258) | Huff capture for a NEW education outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_fast_food` | float64 | outlet-equivalents | 0.0 | 0 → 2.147 (median 0.1897) | Huff capture for a NEW fast_food outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_fitness_recreation` | float64 | outlet-equivalents | 0.0 | 0 → 3.57 (median 0.2425) | Huff capture for a NEW fitness_recreation outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_hawker` | float64 | outlet-equivalents | 0.0 | 0 → 4.963 (median 0.2013) | Huff capture for a NEW hawker outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_health_medical` | float64 | outlet-equivalents | 0.0 | 0 → 4.445 (median 0.277) | Huff capture for a NEW health_medical outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_restaurant` | float64 | outlet-equivalents | 0.0 | 0 → 3.773 (median 0.4262) | Huff capture for a NEW restaurant outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_shopping_retail` | float64 | outlet-equivalents | 0.0 | 0 → 4.226 (median 0.4733) | Huff capture for a NEW shopping_retail outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_supermarket` | float64 | outlet-equivalents | 0.0 | 0 → 3.206 (median 0.1699) | Huff capture for a NEW supermarket outlet (outlet-equivalents vs existing competition; 1.0 = supports one average outlet) |
| `cap_total` | float64 | outlet-equivalents | 0.0 | 0 → 38.41 (median 3.212) | Sum of per-category Huff capture: demand (outlet-equivalents) a NEW outlet at the best hex9 in this hex would win vs existing competition. λ ASSUMED (500/700/1000/1500m priors; not identifiable from data — rankings λ-robust ρ≥0.83) |
...
| `colo_fit_beauty_personal` | float64 | log-lift | 0.0 | -0.4114 → 0.547 (median 0.0786) | Co-location mix-match for beauty_personal: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_cafe_coffee` | float64 | log-lift | 0.0 | -0.3437 → 0.1978 (median 0) | Co-location mix-match for cafe_coffee: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_convenience` | float64 | log-lift | 0.0 | -0.3274 → 0.187 (median 0) | Co-location mix-match for convenience: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_education` | float64 | log-lift | 0.0 | -0.5625 → 0.2059 (median -0.102) | Co-location mix-match for education: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_fast_food` | float64 | log-lift | 0.0 | -0.7249 → 0.266 (median 0) | Co-location mix-match for fast_food: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_fitness_recreation` | float64 | log-lift | 0.0 | -0.5516 → 0.1304 (median -0.0773) | Co-location mix-match for fitness_recreation: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_hawker` | float64 | log-lift | 0.0 | -0.5932 → 0.2667 (median -0.0289) | Co-location mix-match for hawker: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_health_medical` | float64 | log-lift | 0.0 | -0.4839 → 0.2461 (median 0) | Co-location mix-match for health_medical: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_restaurant` | float64 | log-lift | 0.0 | -0.1142 → 0.5724 (median 0.1535) | Co-location mix-match for restaurant: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_shopping_retail` | float64 | log-lift | 0.0 | -0.0667 → 0.4489 (median 0.1253) | Co-location mix-match for shopping_retail: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
| `colo_fit_supermarket` | float64 | log-lift | 0.0 | -0.3589 → 0.1712 (median -0.0402) | Co-location mix-match for supermarket: Σ log lift(c,B) × share of B in the 400 m place mix (count-based lift, bootstrap-significant pairs only) |
...
| `dt_pop` | float64 | persons | 0.0 | 0 → 9899 (median 645.2) | Commuter daytime headcount: pop_resident − AM transit out + AM in (0.62 PT mode share, /22 weekdays). Clipped ≥0. |
...
| `is_highrise` | bool | bool | 0.0 | 0 → 1 (median 0) | True if max_floors >= 10 |
| `is_mrt_interchange` | bool | bool | 0.0 | 0 → 1 (median 0) | True if any station has ≥2 lines (slash-PT_CODE) |
| `iso_transit15_pop` | float64 | persons | 0.0 | 0 → 1.078e+05 (median 42.05) | Population reachable door-to-door in 15 min weekday-AM transit (GTFS route-dir-stop graph + walk arms) |
| `iso_walk10_pop` | float64 | persons | 0.0 | 0 → 1.689e+04 (median 0.87) | Population within 800 m NETWORK walk of hex activity centroid (node-field demand, k=4 multi-source Dijkstra) |
| `iso_walk10_spend` | float64 | persons-weighted | 0.0 | 0 → 3794 (median 0.25) | iso pop × PA affluence index — catchment spending proxy |
...
| `max1_pc_cat_business_office` | float64 |  | 0.0 | 0 → 324 (median 1) | Max over ring-1 neighbours of: Place count in cell: business office category (24-cat taxonomy) |
| `max1_pc_cat_cafe_coffee` | float64 |  | 0.0 | 0 → 51 (median 0) | Max over ring-1 neighbours of: Place count in cell: cafe coffee category (24-cat taxonomy) |
| `max1_pc_cat_education` | float64 |  | 0.0 | 0 → 78 (median 0) | Max over ring-1 neighbours of: Place count in cell: education category (24-cat taxonomy) |
...
| `max1_pc_cat_health_medical` | float64 |  | 0.0 | 0 → 248 (median 0) | Max over ring-1 neighbours of: Place count in cell: health medical category (24-cat taxonomy) |
| `max1_pc_cat_industrial_mfg` | float64 |  | 0.0 | 0 → 148 (median 1) | Max over ring-1 neighbours of: Place count in cell: industrial mfg category (24-cat taxonomy) |
| `max1_pc_cat_residential` | float64 |  | 0.0 | 0 → 33 (median 0) | Max over ring-1 neighbours of: Place count in cell: residential category (24-cat taxonomy) |
| `max1_pc_cat_restaurant` | float64 |  | 0.0 | 0 → 112 (median 0) | Max over ring-1 neighbours of: Place count in cell: restaurant category (24-cat taxonomy) |
| `max1_pc_cat_shopping_retail` | float64 |  | 0.0 | 0 → 251 (median 0) | Max over ring-1 neighbours of: Place count in cell: shopping retail category (24-cat taxonomy) |
...
| `max2_pc_cat_business_office` | float64 |  | 0.0 | 0 → 324 (median 2) | Max over ring-2 neighbours of: Place count in cell: business office category (24-cat taxonomy) |
| `max2_pc_cat_cafe_coffee` | float64 |  | 0.0 | 0 → 51 (median 1) | Max over ring-2 neighbours of: Place count in cell: cafe coffee category (24-cat taxonomy) |
| `max2_pc_cat_education` | float64 |  | 0.0 | 0 → 78 (median 1) | Max over ring-2 neighbours of: Place count in cell: education category (24-cat taxonomy) |
...
| `max2_pc_cat_health_medical` | float64 |  | 0.0 | 0 → 248 (median 0) | Max over ring-2 neighbours of: Place count in cell: health medical category (24-cat taxonomy) |
| `max2_pc_cat_industrial_mfg` | float64 |  | 0.0 | 0 → 148 (median 2) | Max over ring-2 neighbours of: Place count in cell: industrial mfg category (24-cat taxonomy) |
| `max2_pc_cat_residential` | float64 |  | 0.0 | 0 → 33 (median 1) | Max over ring-2 neighbours of: Place count in cell: residential category (24-cat taxonomy) |
| `max2_pc_cat_restaurant` | float64 |  | 0.0 | 0 → 112 (median 1) | Max over ring-2 neighbours of: Place count in cell: restaurant category (24-cat taxonomy) |
| `max2_pc_cat_shopping_retail` | float64 |  | 0.0 | 0 → 251 (median 2) | Max over ring-2 neighbours of: Place count in cell: shopping retail category (24-cat taxonomy) |
...
| `mg_bakery_anchor_strength` | float64 |  | 0.0 | 0 → 1312 (median 0) | Magnet model: strength of the biggest bakery anchor place nearby |
| `mg_bakery_pressure_400m` | float64 |  | 0.0 | 0 → 45 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for bakery |
...
| `mg_bar_nightlife_anchor_strength` | float64 |  | 0.0 | 0 → 277.9 (median 0) | Magnet model: strength of the biggest bar nightlife anchor place nearby |
| `mg_bar_nightlife_pressure_400m` | float64 |  | 0.0 | 0 → 25.43 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for bar nightlife |
...
| `mg_beauty_personal_anchor_strength` | float64 |  | 0.0 | 0 → 1010 (median 0) | Magnet model: strength of the biggest beauty personal anchor place nearby |
| `mg_beauty_personal_pressure_400m` | float64 |  | 0.0 | 0 → 103.9 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for beauty personal |
| `mg_beauty_personal_support_400m` | float64 |  | 0.0 | 0 → 202.2 (median 0) | Magnet model: complementary-category support density within 400 m for beauty personal (demand context, not supply) |
| `mg_business_office_anchor_strength` | float64 |  | 0.0 | 0 → 328.3 (median 0) | Magnet model: strength of the biggest business office anchor place nearby |
| `mg_business_office_pressure_400m` | float64 |  | 0.0 | 0 → 310 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for business office |
| `mg_business_office_support_400m` | float64 |  | 0.0 | 0 → 329.7 (median 0) | Magnet model: complementary-category support density within 400 m for business office (demand context, not supply) |
| `mg_cafe_coffee_anchor_strength` | float64 |  | 0.0 | 0 → 1273 (median 0) | Magnet model: strength of the biggest cafe coffee anchor place nearby |
| `mg_cafe_coffee_pressure_400m` | float64 |  | 0.0 | 0 → 52.29 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for cafe coffee |
| `mg_cafe_coffee_support_400m` | float64 |  | 0.0 | 0 → 221.7 (median 0) | Magnet model: complementary-category support density within 400 m for cafe coffee (demand context, not supply) |
| `mg_convenience_anchor_strength` | float64 |  | 0.0 | 0 → 81.79 (median 0) | Magnet model: strength of the biggest convenience anchor place nearby |
| `mg_convenience_pressure_400m` | float64 |  | 0.0 | 0 → 34.29 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for convenience |
| `mg_convenience_support_400m` | float64 |  | 0.0 | 0 → 49 (median 0) | Magnet model: complementary-category support density within 400 m for convenience (demand context, not supply) |
...
| `mg_education_pressure_400m` | float64 |  | 0.0 | 0 → 71.03 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for education |
| `mg_education_support_400m` | float64 |  | 0.0 | 0 → 45.17 (median 0) | Magnet model: complementary-category support density within 400 m for education (demand context, not supply) |
...
| `mg_entertainment_culture_pressure_400m` | float64 |  | 0.0 | 0 → 18.38 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for entertainment culture |
| `mg_entertainment_culture_support_400m` | float64 |  | 0.0 | 0 → 109.4 (median 0) | Magnet model: complementary-category support density within 400 m for entertainment culture (demand context, not supply) |
| `mg_fast_food_anchor_strength` | float64 |  | 0.0 | 0 → 1168 (median 0) | Magnet model: strength of the biggest fast food anchor place nearby |
...
| `mg_fitness_recreation_anchor_strength` | float64 |  | 0.0 | 0 → 1009 (median 0) | Magnet model: strength of the biggest fitness recreation anchor place nearby |
| `mg_fitness_recreation_pressure_400m` | float64 |  | 0.0 | 0 → 22.66 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for fitness recreation |
...
| `mg_government_public_anchor_strength` | float64 |  | 0.0 | 0 → 72.1 (median 0) | Magnet model: strength of the biggest government public anchor place nearby |
...
| `mg_government_public_support_400m` | float64 |  | 0.0 | 0 → 236.7 (median 0) | Magnet model: complementary-category support density within 400 m for government public (demand context, not supply) |
| `mg_hawker_anchor_strength` | float64 |  | 0.0 | 0 → 88.85 (median 0) | Magnet model: strength of the biggest hawker anchor place nearby |
| `mg_hawker_pressure_400m` | float64 |  | 0.0 | 0 → 120.5 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for hawker |
...
| `mg_health_medical_pressure_400m` | float64 |  | 0.0 | 0 → 156.7 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for health medical |
...
| `mg_hotel_hospitality_pressure_400m` | float64 |  | 0.0 | 0 → 56.39 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for hotel hospitality |
| `mg_hotel_hospitality_support_400m` | float64 |  | 0.0 | 0 → 125 (median 0) | Magnet model: complementary-category support density within 400 m for hotel hospitality (demand context, not supply) |
...
| `mg_industrial_mfg_pressure_400m` | float64 |  | 0.0 | 0 → 133.7 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for industrial mfg |
| `mg_industrial_mfg_support_400m` | float64 |  | 0.0 | 0 → 588.6 (median 0) | Magnet model: complementary-category support density within 400 m for industrial mfg (demand context, not supply) |
| `mg_other_uncategorized_anchor_strength` | float64 |  | 0.0 | 0 → 0 (median 0) | Magnet model: strength of the biggest other uncategorized anchor place nearby |
| `mg_other_uncategorized_pressure_400m` | float64 |  | 0.0 | 0 → 0 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for other uncategorized |
| `mg_other_uncategorized_support_400m` | float64 |  | 0.0 | 0 → 0 (median 0) | Magnet model: complementary-category support density within 400 m for other uncategorized (demand context, not supply) |
...
| `mg_park_open_pressure_400m` | float64 |  | 0.0 | 0 → 10 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for park open |
...
| `mg_religious_worship_pressure_400m` | float64 |  | 0.0 | 0 → 20.31 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for religious worship |
| `mg_religious_worship_support_400m` | float64 |  | 0.0 | 0 → 26.5 (median 0) | Magnet model: complementary-category support density within 400 m for religious worship (demand context, not supply) |
...
| `mg_residential_pressure_400m` | float64 |  | 0.0 | 0 → 27.96 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for residential |
...
| `mg_restaurant_anchor_strength` | float64 |  | 0.0 | 0 → 1180 (median 0) | Magnet model: strength of the biggest restaurant anchor place nearby |
| `mg_restaurant_pressure_400m` | float64 |  | 0.0 | 0 → 141.1 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for restaurant |
| `mg_restaurant_support_400m` | float64 |  | 0.0 | 0 → 126.5 (median 0) | Magnet model: complementary-category support density within 400 m for restaurant (demand context, not supply) |
| `mg_services_anchor_strength` | float64 |  | 0.0 | 0 → 1089 (median 0) | Magnet model: strength of the biggest services anchor place nearby |
| `mg_services_pressure_400m` | float64 |  | 0.0 | 0 → 231.2 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for services |
| `mg_services_support_400m` | float64 |  | 0.0 | 0 → 331.8 (median 0) | Magnet model: complementary-category support density within 400 m for services (demand context, not supply) |
| `mg_shopping_retail_anchor_strength` | float64 |  | 0.0 | 0 → 1172 (median 0) | Magnet model: strength of the biggest shopping retail anchor place nearby |
| `mg_shopping_retail_pressure_400m` | float64 |  | 0.0 | 0 → 136.1 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for shopping retail |
| `mg_shopping_retail_support_400m` | float64 |  | 0.0 | 0 → 197.8 (median 0) | Magnet model: complementary-category support density within 400 m for shopping retail (demand context, not supply) |
| `mg_supermarket_anchor_strength` | float64 |  | 0.0 | 0 → 42.41 (median 0) | Magnet model: strength of the biggest supermarket anchor place nearby |
...
| `mg_transportation_anchor_strength` | float64 |  | 0.0 | 0 → 1157 (median 0) | Magnet model: strength of the biggest transportation anchor place nearby |
| `mg_transportation_pressure_400m` | float64 |  | 0.0 | 0 → 25 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for transportation |
| `mg_transportation_support_400m` | float64 |  | 0.0 | 0 → 277.8 (median 0) | Magnet model: complementary-category support density within 400 m for transportation (demand context, not supply) |
...
| `od_throughput` | float64 |  | 0.0 | 0 → 1.966e+06 (median 191.9) | LTA origin-destination flow metric: throughput (weekday monthly, bus+train) |
...
| `pc_cat_automated_kiosk` | float64 |  | 0.0 | 0 → 10 (median 0) | Place count in cell: automated kiosk category (24-cat taxonomy) |
| `pc_cat_bakery` | float64 |  | 0.0 | 0 → 22 (median 0) | Place count in cell: bakery category (24-cat taxonomy) |
| `pc_cat_bar_nightlife` | float64 |  | 0.0 | 0 → 28 (median 0) | Place count in cell: bar nightlife category (24-cat taxonomy) |
| `pc_cat_beauty_personal` | float64 |  | 0.0 | 0 → 106 (median 0) | Place count in cell: beauty personal category (24-cat taxonomy) |
| `pc_cat_business_office` | float64 |  | 0.0 | 0 → 324 (median 0) | Place count in cell: business office category (24-cat taxonomy) |
| `pc_cat_cafe_coffee` | float64 |  | 0.0 | 0 → 51 (median 0) | Place count in cell: cafe coffee category (24-cat taxonomy) |
| `pc_cat_convenience` | float64 |  | 0.0 | 0 → 17 (median 0) | Place count in cell: convenience category (24-cat taxonomy) |
| `pc_cat_education` | float64 |  | 0.0 | 0 → 78 (median 0) | Place count in cell: education category (24-cat taxonomy) |
| `pc_cat_entertainment_culture` | float64 |  | 0.0 | 0 → 25 (median 0) | Place count in cell: entertainment culture category (24-cat taxonomy) |
| `pc_cat_fast_food` | float64 |  | 0.0 | 0 → 12 (median 0) | Place count in cell: fast food category (24-cat taxonomy) |
| `pc_cat_financial_services` | float64 |  | 0.0 | 0 → 154 (median 0) | Place count in cell: financial services category (24-cat taxonomy) |
| `pc_cat_fitness_recreation` | float64 |  | 0.0 | 0 → 47 (median 0) | Place count in cell: fitness recreation category (24-cat taxonomy) |
| `pc_cat_government_public` | float64 |  | 0.0 | 0 → 29 (median 0) | Place count in cell: government public category (24-cat taxonomy) |
| `pc_cat_hawker` | float64 |  | 0.0 | 0 → 96 (median 0) | Place count in cell: hawker category (24-cat taxonomy) |
| `pc_cat_health_medical` | float64 |  | 0.0 | 0 → 248 (median 0) | Place count in cell: health medical category (24-cat taxonomy) |
| `pc_cat_hotel_hospitality` | float64 |  | 0.0 | 0 → 51 (median 0) | Place count in cell: hotel hospitality category (24-cat taxonomy) |
| `pc_cat_industrial_mfg` | float64 |  | 0.0 | 0 → 148 (median 0) | Place count in cell: industrial mfg category (24-cat taxonomy) |
| `pc_cat_other_uncategorized` | float64 |  | 0.0 | 0 → 25 (median 0) | Place count in cell: other uncategorized category (24-cat taxonomy) |
| `pc_cat_park_open` | float64 |  | 0.0 | 0 → 19 (median 0) | Place count in cell: park open category (24-cat taxonomy) |
| `pc_cat_religious_worship` | float64 |  | 0.0 | 0 → 29 (median 0) | Place count in cell: religious worship category (24-cat taxonomy) |
| `pc_cat_residential` | float64 |  | 0.0 | 0 → 33 (median 0) | Place count in cell: residential category (24-cat taxonomy) |
| `pc_cat_restaurant` | float64 |  | 0.0 | 0 → 112 (median 0) | Place count in cell: restaurant category (24-cat taxonomy) |
| `pc_cat_services` | float64 |  | 0.0 | 0 → 260 (median 0) | Place count in cell: services category (24-cat taxonomy) |
| `pc_cat_shopping_retail` | float64 |  | 0.0 | 0 → 251 (median 0) | Place count in cell: shopping retail category (24-cat taxonomy) |
| `pc_cat_supermarket` | float64 |  | 0.0 | 0 → 28 (median 0) | Place count in cell: supermarket category (24-cat taxonomy) |
| `pc_cat_transportation` | float64 |  | 0.0 | 0 → 31 (median 0) | Place count in cell: transportation category (24-cat taxonomy) |
| `pc_diversity` | float64 | 0-1 | 0.0 | 0 → 2.969 (median 0) | Category entropy of the place mix — high = mixed-use |
| `pc_dominant_category` | object | category | 0.0 | 27 unique · `none` | Most common place category in cell |
...
| `pc_unique_brands` | float64 | count | 0.0 | 0 → 201 (median 0) | Distinct retail/F&B brands present — chain richness |
...
| `pw1_pc_cat_business_office` | float64 |  | 0.0 | 0 → 162.1 (median 0) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: business office category (24-cat taxonomy) |
| `pw1_pc_cat_cafe_coffee` | float64 |  | 0.0 | 0 → 33.77 (median 0) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: cafe coffee category (24-cat taxonomy) |
| `pw1_pc_cat_education` | float64 |  | 0.0 | 0 → 43.89 (median 0) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: education category (24-cat taxonomy) |
...
| `pw1_pc_cat_health_medical` | float64 |  | 0.0 | 0 → 73.26 (median 0) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: health medical category (24-cat taxonomy) |
| `pw1_pc_cat_industrial_mfg` | float64 |  | 0.0 | 0 → 98.82 (median 0) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: industrial mfg category (24-cat taxonomy) |
...
| `pw1_pc_cat_restaurant` | float64 |  | 0.0 | 0 → 86.45 (median 0) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: restaurant category (24-cat taxonomy) |
| `pw1_pc_cat_shopping_retail` | float64 |  | 0.0 | 0 → 111.5 (median 0) | Proximity-weighted (distance-decayed) ring-1 aggregate of: Place count in cell: shopping retail category (24-cat taxonomy) |
...
| `pw2_pc_cat_business_office` | float64 |  | 0.0 | 0 → 162.7 (median 0) | Proximity-weighted ring-2 aggregate of: Place count in cell: business office category (24-cat taxonomy) |
| `pw2_pc_cat_cafe_coffee` | float64 |  | 0.0 | 0 → 28.87 (median 0) | Proximity-weighted ring-2 aggregate of: Place count in cell: cafe coffee category (24-cat taxonomy) |
| `pw2_pc_cat_education` | float64 |  | 0.0 | 0 → 38.49 (median 0) | Proximity-weighted ring-2 aggregate of: Place count in cell: education category (24-cat taxonomy) |
| `pw2_pc_cat_hawker` | float64 |  | 0.0 | 0 → 47.03 (median 0) | Proximity-weighted ring-2 aggregate of: Place count in cell: hawker category (24-cat taxonomy) |
| `pw2_pc_cat_health_medical` | float64 |  | 0.0 | 0 → 46.31 (median 0) | Proximity-weighted ring-2 aggregate of: Place count in cell: health medical category (24-cat taxonomy) |
| `pw2_pc_cat_industrial_mfg` | float64 |  | 0.0 | 0 → 84.21 (median 0) | Proximity-weighted ring-2 aggregate of: Place count in cell: industrial mfg category (24-cat taxonomy) |
| `pw2_pc_cat_residential` | float64 |  | 0.0 | 0 → 24.18 (median 0) | Proximity-weighted ring-2 aggregate of: Place count in cell: residential category (24-cat taxonomy) |
| `pw2_pc_cat_restaurant` | float64 |  | 0.0 | 0 → 75.03 (median 0) | Proximity-weighted ring-2 aggregate of: Place count in cell: restaurant category (24-cat taxonomy) |
| `pw2_pc_cat_shopping_retail` | float64 |  | 0.0 | 0 → 83.12 (median 0) | Proximity-weighted ring-2 aggregate of: Place count in cell: shopping retail category (24-cat taxonomy) |
...
| `rent_confidence` | object | category | 0.0 | 4 unique · `na` | Retail-rent estimate confidence (nous V4): high (commercial_intensity>0.4 & footfall>0) | medium | low | na. |
| `rent_hdb_4r_est_pm` | float64 |  | 76.1 | 2634 → 5080 (median 3090) |  |
| `rent_hdb_est_psf` | float64 |  | 76.1 | 2.718 → 5.243 (median 3.189) |  |
| `rent_occ_cost_psf` | float64 |  | 42.8 | 2.02 → 8.174 (median 4.392) |  |
| `rent_occ_cost_source` | object |  | 0.0 | 3 unique · `none` |  |
...
| `roi_cap_per_rent_cafe_coffee` | float64 | ratio | 43.9 | 0.0009 → 1.051 (median 0.1854) | cap_cafe_coffee / rent_resi_psf_med — opportunity per occupancy-cost proxy (rank heuristic). NaN where no rent |
| `roi_cap_per_rent_restaurant` | float64 | ratio | 43.9 | 0.0009 → 1.124 (median 0.2314) | cap_restaurant / rent_resi_psf_med — opportunity per occupancy-cost proxy (rank heuristic). NaN where no rent |
| `roi_cap_per_rent_shopping_retail` | float64 | ratio | 43.9 | 0.0017 → 1.229 (median 0.2505) | cap_shopping_retail / rent_resi_psf_med — opportunity per occupancy-cost proxy (rank heuristic). NaN where no rent |
| `roi_cap_per_rent_supermarket` | float64 | ratio | 43.9 | 0.0003 → 0.948 (median 0.1537) | cap_supermarket / rent_resi_psf_med — opportunity per occupancy-cost proxy (rank heuristic). NaN where no rent |
| `roi_cap_per_rent_total` | float64 | ratio | 43.9 | 0.017 → 11.02 (median 2.038) | cap_total / rent_resi_psf_med — opportunity per occupancy-cost proxy (rank heuristic). NaN where no rent |
...
| `zone_type` | object | category | 0.0 | 8 unique · `transport_terminal` | URA zone type of the hex (PA→SZ→hex8 propagated) |
| `zone_type_broad` | object | category | 0.0 | 8 unique · `transport_terminal` | Broad zone class (residential/industrial/airport/nature/islands/future) — the NA-masking rule |
...
| `format_fit_score` | float64 | 0-100 | 17.2 | 0 → 100 (median 0) | Retail format-fit (nous V4): score100(minmax(walkability_score) * minmax(retail_footfall_score) * minmax(colo_fit_cat)). Footfall term now the V4 decontaminated retail_footfall_score, NOT vis_exit_footfall. |
...
| `in_primary_school_zone` | int64 | bool | 0.0 | 0 → 1 (median 0) | Cell intersects a primary-school zone |
| `in_silver_zone` | int64 | bool | 0.0 | 0 → 1 (median 0) | Cell intersects an elderly-priority Silver Zone |
| `insurance_accumulation_band` | float64 |  | 17.2 | 0 → 100 (median 26.3) |  |
| `insurance_risk_score` | float64 |  | 17.2 | 0 → 100 (median 40) |  |
...
| `mg_bakery_anchor_strength` | float64 |  | 0.0 | 0 → 1104 (median 13.15) | Magnet model: strength of the biggest bakery anchor place nearby |
| `mg_bakery_pressure_400m` | float64 |  | 0.0 | 0 → 39.8 (median 2.5) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for bakery |
| `mg_bakery_support_400m` | float64 |  | 0.0 | 0 → 208 (median 9) | Magnet model: complementary-category support density within 400 m for bakery (demand context, not supply) |
| `mg_bar_nightlife_anchor_strength` | float64 |  | 0.0 | 0 → 214.6 (median 0) | Magnet model: strength of the biggest bar nightlife anchor place nearby |
| `mg_bar_nightlife_pressure_400m` | float64 |  | 0.0 | 0 → 23.26 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for bar nightlife |
| `mg_bar_nightlife_support_400m` | float64 |  | 0.0 | 0 → 91.37 (median 0) | Magnet model: complementary-category support density within 400 m for bar nightlife (demand context, not supply) |
| `mg_beauty_personal_anchor_strength` | float64 |  | 0.0 | 0 → 896 (median 15.4) | Magnet model: strength of the biggest beauty personal anchor place nearby |
| `mg_beauty_personal_pressure_400m` | float64 |  | 0.0 | 0 → 103.9 (median 2.929) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for beauty personal |
| `mg_beauty_personal_support_400m` | float64 |  | 0.0 | 0 → 199.4 (median 8.025) | Magnet model: complementary-category support density within 400 m for beauty personal (demand context, not supply) |
| `mg_business_office_anchor_strength` | float64 |  | 0.0 | 0 → 327.9 (median 5.994) | Magnet model: strength of the biggest business office anchor place nearby |
| `mg_business_office_pressure_400m` | float64 |  | 0.0 | 0 → 210.2 (median 3.393) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for business office |
| `mg_business_office_support_400m` | float64 |  | 0.0 | 0 → 269.8 (median 10) | Magnet model: complementary-category support density within 400 m for business office (demand context, not supply) |
| `mg_cafe_coffee_anchor_strength` | float64 |  | 0.0 | 0 → 1118 (median 28.54) | Magnet model: strength of the biggest cafe coffee anchor place nearby |
| `mg_cafe_coffee_pressure_400m` | float64 |  | 0.0 | 0 → 35.49 (median 3.038) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for cafe coffee |
| `mg_cafe_coffee_support_400m` | float64 |  | 0.0 | 0 → 168 (median 10.93) | Magnet model: complementary-category support density within 400 m for cafe coffee (demand context, not supply) |
| `mg_convenience_anchor_strength` | float64 |  | 0.0 | 0 → 78.35 (median 5.583) | Magnet model: strength of the biggest convenience anchor place nearby |
| `mg_convenience_pressure_400m` | float64 |  | 0.0 | 0 → 26.23 (median 3) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for convenience |
| `mg_convenience_support_400m` | float64 |  | 0.0 | 0 → 33.5 (median 6.388) | Magnet model: complementary-category support density within 400 m for convenience (demand context, not supply) |
| `mg_education_anchor_strength` | float64 |  | 0.0 | 0 → 19.71 (median 0.4025) | Magnet model: strength of the biggest education anchor place nearby |
| `mg_education_pressure_400m` | float64 |  | 0.0 | 0 → 55.78 (median 2.366) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for education |
| `mg_education_support_400m` | float64 |  | 0.0 | 0 → 37.81 (median 4.4) | Magnet model: complementary-category support density within 400 m for education (demand context, not supply) |
| `mg_entertainment_culture_anchor_strength` | float64 |  | 0.0 | 0 → 730.9 (median 2.143) | Magnet model: strength of the biggest entertainment culture anchor place nearby |
| `mg_entertainment_culture_pressure_400m` | float64 |  | 0.0 | 0 → 18.11 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for entertainment culture |
| `mg_entertainment_culture_support_400m` | float64 |  | 0.0 | 0 → 92 (median 0.333) | Magnet model: complementary-category support density within 400 m for entertainment culture (demand context, not supply) |
| `mg_fast_food_anchor_strength` | float64 |  | 0.0 | 0 → 1152 (median 7.498) | Magnet model: strength of the biggest fast food anchor place nearby |
| `mg_fast_food_pressure_400m` | float64 |  | 0.0 | 0 → 104.5 (median 4.167) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for fast food |
| `mg_fast_food_support_400m` | float64 |  | 0.0 | 0 → 144.5 (median 6.417) | Magnet model: complementary-category support density within 400 m for fast food (demand context, not supply) |
| `mg_fitness_recreation_anchor_strength` | float64 |  | 0.0 | 0 → 921.3 (median 8.531) | Magnet model: strength of the biggest fitness recreation anchor place nearby |
| `mg_fitness_recreation_pressure_400m` | float64 |  | 0.0 | 0 → 22.14 (median 0.5475) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for fitness recreation |
| `mg_fitness_recreation_support_400m` | float64 |  | 0.0 | 0 → 153.8 (median 4.775) | Magnet model: complementary-category support density within 400 m for fitness recreation (demand context, not supply) |
| `mg_government_public_anchor_strength` | float64 |  | 0.0 | 0 → 66.33 (median 1.357) | Magnet model: strength of the biggest government public anchor place nearby |
| `mg_government_public_pressure_400m` | float64 |  | 0.0 | 0 → 11.18 (median 0.2) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for government public |
| `mg_government_public_support_400m` | float64 |  | 0.0 | 0 → 182.1 (median 4.5) | Magnet model: complementary-category support density within 400 m for government public (demand context, not supply) |
| `mg_hawker_anchor_strength` | float64 |  | 0.0 | 0 → 69.59 (median 2.865) | Magnet model: strength of the biggest hawker anchor place nearby |
| `mg_hawker_pressure_400m` | float64 |  | 0.0 | 0 → 120.5 (median 7.681) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for hawker |
| `mg_hawker_support_400m` | float64 |  | 0.0 | 0 → 42.13 (median 6.886) | Magnet model: complementary-category support density within 400 m for hawker (demand context, not supply) |
| `mg_health_medical_anchor_strength` | float64 |  | 0.0 | 0 → 72.52 (median 4.123) | Magnet model: strength of the biggest health medical anchor place nearby |
| `mg_health_medical_pressure_400m` | float64 |  | 0.0 | 0 → 113.3 (median 2) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for health medical |
| `mg_health_medical_support_400m` | float64 |  | 0.0 | 0 → 157.5 (median 5.75) | Magnet model: complementary-category support density within 400 m for health medical (demand context, not supply) |
| `mg_hotel_hospitality_anchor_strength` | float64 |  | 0.0 | 0 → 856.2 (median 0) | Magnet model: strength of the biggest hotel hospitality anchor place nearby |
...
| `mg_hotel_hospitality_support_400m` | float64 |  | 0.0 | 0 → 98.68 (median 0) | Magnet model: complementary-category support density within 400 m for hotel hospitality (demand context, not supply) |
| `mg_industrial_mfg_anchor_strength` | float64 |  | 0.0 | 0 → 209.6 (median 4.862) | Magnet model: strength of the biggest industrial mfg anchor place nearby |
| `mg_industrial_mfg_pressure_400m` | float64 |  | 0.0 | 0 → 77.84 (median 2.309) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for industrial mfg |
| `mg_industrial_mfg_support_400m` | float64 |  | 0.0 | 0 → 422.1 (median 6) | Magnet model: complementary-category support density within 400 m for industrial mfg (demand context, not supply) |
| `mg_other_uncategorized_anchor_strength` | float64 |  | 0.0 | 0 → 0 (median 0) | Magnet model: strength of the biggest other uncategorized anchor place nearby |
| `mg_other_uncategorized_pressure_400m` | float64 |  | 0.0 | 0 → 0 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for other uncategorized |
| `mg_other_uncategorized_support_400m` | float64 |  | 0.0 | 0 → 0 (median 0) | Magnet model: complementary-category support density within 400 m for other uncategorized (demand context, not supply) |
| `mg_park_open_anchor_strength` | float64 |  | 0.0 | 0 → 13.26 (median 0.208) | Magnet model: strength of the biggest park open anchor place nearby |
| `mg_park_open_pressure_400m` | float64 |  | 0.0 | 0 → 7.364 (median 0.667) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for park open |
| `mg_park_open_support_400m` | float64 |  | 0.0 | 0 → 81.5 (median 3.667) | Magnet model: complementary-category support density within 400 m for park open (demand context, not supply) |
...
| `mg_religious_worship_pressure_400m` | float64 |  | 0.0 | 0 → 11.44 (median 0) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for religious worship |
| `mg_religious_worship_support_400m` | float64 |  | 0.0 | 0 → 17 (median 0.732) | Magnet model: complementary-category support density within 400 m for religious worship (demand context, not supply) |
| `mg_residential_anchor_strength` | float64 |  | 0.0 | 0 → 655.2 (median 7.612) | Magnet model: strength of the biggest residential anchor place nearby |
| `mg_residential_pressure_400m` | float64 |  | 0.0 | 0 → 15.72 (median 2.997) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for residential |
| `mg_residential_support_400m` | float64 |  | 0.0 | 0 → 48.67 (median 3.896) | Magnet model: complementary-category support density within 400 m for residential (demand context, not supply) |
| `mg_restaurant_anchor_strength` | float64 |  | 0.0 | 0 → 928 (median 21.93) | Magnet model: strength of the biggest restaurant anchor place nearby |
| `mg_restaurant_pressure_400m` | float64 |  | 0.0 | 0 → 128.1 (median 10.26) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for restaurant |
| `mg_restaurant_support_400m` | float64 |  | 0.0 | 0 → 95.4 (median 4.477) | Magnet model: complementary-category support density within 400 m for restaurant (demand context, not supply) |
| `mg_services_anchor_strength` | float64 |  | 0.0 | 0 → 934.2 (median 17.97) | Magnet model: strength of the biggest services anchor place nearby |
| `mg_services_pressure_400m` | float64 |  | 0.0 | 0 → 177.7 (median 3.026) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for services |
| `mg_services_support_400m` | float64 |  | 0.0 | 0 → 252.8 (median 8.826) | Magnet model: complementary-category support density within 400 m for services (demand context, not supply) |
| `mg_shopping_retail_anchor_strength` | float64 |  | 0.0 | 0 → 1030 (median 21.34) | Magnet model: strength of the biggest shopping retail anchor place nearby |
| `mg_shopping_retail_pressure_400m` | float64 |  | 0.0 | 0 → 101.2 (median 5.593) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for shopping retail |
| `mg_shopping_retail_support_400m` | float64 |  | 0.0 | 0 → 165.6 (median 8.062) | Magnet model: complementary-category support density within 400 m for shopping retail (demand context, not supply) |
...
| `mg_supermarket_pressure_400m` | float64 |  | 0.0 | 0 → 32.74 (median 2.6) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for supermarket |
| `mg_supermarket_support_400m` | float64 |  | 0.0 | 0 → 169 (median 7.333) | Magnet model: complementary-category support density within 400 m for supermarket (demand context, not supply) |
| `mg_transportation_anchor_strength` | float64 |  | 0.0 | 0 → 933 (median 12.48) | Magnet model: strength of the biggest transportation anchor place nearby |
| `mg_transportation_pressure_400m` | float64 |  | 0.0 | 0 → 21.61 (median 2.748) | Magnet model: 400 m distance-decayed SAME-category competitive pressure for transportation |
| `mg_transportation_support_400m` | float64 |  | 0.0 | 0 → 237.2 (median 6.535) | Magnet model: complementary-category support density within 400 m for transportation (demand context, not supply) |
| `mobility_access_score` | float64 |  | 17.2 | 0 → 100 (median 72.35) |  |
| `mobility_crowding_score` | float64 |  | 17.2 | 0 → 100 (median 0) |  |
| `mobility_desert_priority` | float64 |  | 17.2 | 0 → 100 (median 4.5) |  |
| `mobility_firstlast_gap_score` | float64 |  | 17.2 | 0 → 91 (median 0) |  |
| `mobility_parking_stress` | float64 |  | 17.2 | 0 → 100 (median 16) |  |
| `mobility_ridehail_score` | float64 |  | 17.2 | 0 → 100 (median 0) |  |
| `mobility_tod_score` | float64 |  | 17.2 | 0 → 100 (median 0) |  |
| `modal_split_proxy` | float64 |  | 17.2 | 0 → 100 (median 14) |  |
...
| `pc_cat_automated_kiosk` | int64 |  | 0.0 | 0 → 42 (median 4.5) | Place count in cell: automated kiosk category (24-cat taxonomy) |
| `pc_cat_bakery` | int64 |  | 0.0 | 0 → 64 (median 3) | Place count in cell: bakery category (24-cat taxonomy) |
| `pc_cat_bar_nightlife` | int64 |  | 0.0 | 0 → 79 (median 1) | Place count in cell: bar nightlife category (24-cat taxonomy) |
| `pc_cat_beauty_personal` | int64 |  | 0.0 | 0 → 304 (median 11.5) | Place count in cell: beauty personal category (24-cat taxonomy) |
| `pc_cat_business_office` | int64 |  | 0.0 | 0 → 1205 (median 23) | Place count in cell: business office category (24-cat taxonomy) |
| `pc_cat_cafe_coffee` | int64 |  | 0.0 | 0 → 170 (median 13.5) | Place count in cell: cafe coffee category (24-cat taxonomy) |
| `pc_cat_convenience` | int64 |  | 0.0 | 0 → 55 (median 4) | Place count in cell: convenience category (24-cat taxonomy) |
| `pc_cat_education` | int64 |  | 0.0 | 0 → 280 (median 24) | Place count in cell: education category (24-cat taxonomy) |
| `pc_cat_entertainment_culture` | int64 |  | 0.0 | 0 → 107 (median 3) | Place count in cell: entertainment culture category (24-cat taxonomy) |
| `pc_cat_fast_food` | int64 |  | 0.0 | 0 → 27 (median 1) | Place count in cell: fast food category (24-cat taxonomy) |
| `pc_cat_financial_services` | int64 |  | 0.0 | 0 → 177 (median 5) | Place count in cell: financial services category (24-cat taxonomy) |
| `pc_cat_fitness_recreation` | int64 |  | 0.0 | 0 → 85 (median 8) | Place count in cell: fitness recreation category (24-cat taxonomy) |
| `pc_cat_government_public` | int64 |  | 0.0 | 0 → 51 (median 4) | Place count in cell: government public category (24-cat taxonomy) |
| `pc_cat_hawker` | int64 |  | 0.0 | 0 → 202 (median 10) | Place count in cell: hawker category (24-cat taxonomy) |
| `pc_cat_health_medical` | int64 |  | 0.0 | 0 → 417 (median 12) | Place count in cell: health medical category (24-cat taxonomy) |
| `pc_cat_hotel_hospitality` | int64 |  | 0.0 | 0 → 93 (median 1) | Place count in cell: hotel hospitality category (24-cat taxonomy) |
| `pc_cat_industrial_mfg` | int64 |  | 0.0 | 0 → 910 (median 17) | Place count in cell: industrial mfg category (24-cat taxonomy) |
| `pc_cat_other_uncategorized` | int64 |  | 0.0 | 0 → 103 (median 7) | Place count in cell: other uncategorized category (24-cat taxonomy) |
| `pc_cat_park_open` | int64 |  | 0.0 | 0 → 89 (median 10) | Place count in cell: park open category (24-cat taxonomy) |
| `pc_cat_religious_worship` | int64 |  | 0.0 | 0 → 133 (median 3) | Place count in cell: religious worship category (24-cat taxonomy) |
| `pc_cat_residential` | int64 |  | 0.0 | 0 → 523 (median 27) | Place count in cell: residential category (24-cat taxonomy) |
| `pc_cat_restaurant` | int64 |  | 0.0 | 0 → 493 (median 20) | Place count in cell: restaurant category (24-cat taxonomy) |
| `pc_cat_services` | int64 |  | 0.0 | 0 → 1148 (median 36) | Place count in cell: services category (24-cat taxonomy) |
| `pc_cat_shopping_retail` | int64 |  | 0.0 | 0 → 646 (median 24) | Place count in cell: shopping retail category (24-cat taxonomy) |
| `pc_cat_supermarket` | int64 |  | 0.0 | 0 → 67 (median 6) | Place count in cell: supermarket category (24-cat taxonomy) |
| `pc_cat_transportation` | int64 |  | 0.0 | 0 → 242 (median 31.5) | Place count in cell: transportation category (24-cat taxonomy) |
| `pc_diversity` | float64 | 0-1 | 0.0 | -0 → 2.943 (median 2.698) | Category entropy of the place mix — high = mixed-use |
| `pc_dominant_category` | object | category | 0.0 | 16 unique · `beauty_personal` | Most common place category in cell |
...
| `pc_unique_brands` | int64 | count | 0.0 | 0 → 348 (median 27) | Distinct retail/F&B brands present — chain richness |
...
| `re_collateral_score` | float64 |  | 17.2 | 3.4 → 100 (median 45.35) |  |
| `re_enbloc_score` | float64 |  | 17.2 | 0 → 100 (median 9.95) |  |
| `re_feasibility_score` | float64 |  | 17.2 | 0 → 100 (median 22.4) |  |
| `re_lease_decay_penalty` | float64 |  | 17.2 | 0 → 100 (median 25) |  |
| `re_livability_score` | float64 |  | 17.2 | 0 → 100 (median 74.8) |  |
| `re_momentum_score` | float64 |  | 17.2 | 0 → 100 (median 25.3) |  |
| `re_yield_proxy` | float64 |  | 17.2 | 0 → 8.2 (median 0) |  |
| `rent_demand_tier` | float64 |  | 17.2 | 0 → 100 (median 58.7) |  |
| `retail_cannibalization_score` | float64 |  | 17.2 | 0 → 100 (median 11) |  |
| `retail_competition_pressure` | float64 |  | 17.2 | 0 → 100 (median 14.7) |  |
| `retail_delivery_score` | float64 |  | 17.2 | 0 → 100 (median 5.1) |  |
| `retail_footfall_score` | float64 | 0-100 | 17.2 | 0 → 100 (median 23.05) | Pedestrian-footfall proxy (nous V4). Percentile of 0.82*dt_pop + 0.12*iso_transit15_pop + 0.06*iso_walk10_pop among scored cells; cells with shops but no residents get a low (1-15) commercial rescue; NaN for terminals/nature/reserve. EXCLUDES vis_exit_footfall (transit-exit point-source) and od_throughput (embedding probe target). dt_pop-corr 0.99; hubs (Orchard/Bugis/Raffles/Tampines/Jurong E) top-decile; dead maritime port reads ~0. |
| `retail_whitespace_score` | float64 |  | 17.2 | 0 → 78.1 (median 34) |  |
| `risk_auto_score` | float64 |  | 17.2 | 0 → 100 (median 5) |  |
| `risk_bi_failure_score` | float64 |  | 17.2 | 0 → 100 (median 50.3) |  |
| `risk_coastal_proxy` | float64 |  | 17.2 | 0 → 57 (median 2) |  |
| `risk_collateral_score` | float64 |  | 17.2 | 0 → 100 (median 45) |  |
| `risk_fire_score` | float64 |  | 17.2 | 0 → 100 (median 0.3) |  |
| `risk_health_score` | float64 |  | 17.2 | 0 → 100 (median 0) |  |
| `risk_nuisance_score` | float64 |  | 17.2 | 0 → 100 (median 14) |  |
...
| `utility_diurnal_swing` | float64 |  | 17.2 | -100 → 500 (median -3) |  |
| `utility_equity_score` | float64 |  | 17.2 | 0 → 94 (median 1.75) |  |
| `utility_ev_gap_score` | float64 |  | 17.2 | 0 → 100 (median 9.95) |  |
| `utility_load_growth_score` | float64 |  | 17.2 | 0 → 100 (median 29.35) |  |
| `utility_load_score` | float64 |  | 17.2 | 0 → 100 (median 35.95) |  |
| `utility_resilience_score` | float64 |  | 17.2 | 0 → 100 (median 59.45) |  |
| `utility_waste_score` | float64 |  | 17.2 | 0 → 100 (median 23) |  |
| `utility_water_score` | float64 |  | 17.2 | 0 → 100 (median 25) |  |
...
| `brand_norm` | object | string | 88.9 | 2381 unique · `Osia` | Normalized brand name |
| `brand_source` | object | categorical | 89.3 | 3 unique · `llm` | scrape | name_pattern |
| `canonical_id` | object |  | 0.0 | 189094 unique · `c5Wl6sW53JSX` |  |
...
| `host_venue` | object |  | 0.0 | 4361 unique · `` |  |
...
| `is_duplicate` | bool |  | 0.0 | 0 → 1 (median 0) |  |
...
| `is_phantom_suspect` | bool |  | 0.0 | 0 → 1 (median 0) |  |
| `is_storefront` | bool |  | 0.0 | 0 → 1 (median 1) |  |
...
| `operator` | object |  | 0.0 | 13 unique · `` |  |
| `operator_name` | object |  | 0.0 | 170597 unique · `Golden Hill Landscape Pte. Ltd.` |  |
| `parent_brand` | object |  | 0.0 | 32 unique · `` |  |
...
| `plexis_category` | object | categorical | 0.0 | 26 unique · `services` | Resolved 24-category Plexis taxonomy |
...
| `zero_reviews` | bool |  | 0.0 | 0 → 1 (median 0) |  |
