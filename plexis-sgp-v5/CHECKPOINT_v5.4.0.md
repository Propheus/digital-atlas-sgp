# Plexis SGP — Checkpoint v5.4.0

**Generated:** 2026-06-13T06:37:13  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 51 (in catalog) · **Features:** 2735 (2735 with curated descriptions)  
**Files indexed:** 258 · **Total size:** 483.7 MB
...
| `places/place_embedding_plexis_p1_64d.parquet` | place | 190,591 × 65 | p1 | Plexis-P1 64d contrastive place embedding (no rating signals; essence+micrograph+context; 9/9 exam passed) |
...
| `places/place_embedding_plexis_p1_64d.parquet` | 75.1 |
...
| `places/sgp_places_final.parquet` | 12.1 |
| `places/sgp_places_branded.parquet` | 11.0 |
| `places/sgp_places_categorized.parquet` | 10.9 |
| `places/sgp_places_geoattached.parquet` | 10.8 |
...
_Checkpoint manifest: `CHECKPOINT_v5.4.0.json`. Atlas-1 backup: `plexis-sgp-v5.4.0.tar.gz`._