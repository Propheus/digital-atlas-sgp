# Plexis SGP — Checkpoint v4.2.0

**Generated:** 2026-04-29T16:55:50  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 34 (in catalog) · **Features:** 1007 (931 with curated descriptions)  
**Files indexed:** 156 · **Total size:** 261.7 MB
...
| `hex/hex9_all_features.parquet` | 3.9 |
...
_Checkpoint manifest: `CHECKPOINT_v4.2.0.json`. Atlas-1 backup: `plexis-sgp-v4.2.0.tar.gz`._