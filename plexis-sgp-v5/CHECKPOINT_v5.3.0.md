# Plexis SGP — Checkpoint v5.3.0

**Generated:** 2026-06-11T05:06:07  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 50 (in catalog) · **Features:** 2735 (all described: 1564 curated + 1171 pattern-derived)  
**Files indexed:** 255 · **Total size:** 407.9 MB
...
_Checkpoint manifest: `CHECKPOINT_v5.3.0.json`. Atlas-1 backup: `plexis-sgp-v5.3.0.tar.gz`._