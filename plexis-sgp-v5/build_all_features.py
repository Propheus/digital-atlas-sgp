...
NAN_KEEP = ("dt_ratio", "iso_severance_ratio", "rent_resi_psf_med",
            ...
            # S11 mobility: NaN = not-scored / not-applicable (zone_type rule)
            "adq_", "min15_", "time_to_", "mrt_reach_", "peak_wait",
            "crowding_load_factor", "last_mile_friction", "multimodal_score",
            "linkway_per_road_km", "pr_share", "low_income_share")
...
def main():
    ...
    SS_LAYERS8 = ["hex8_daytime_pop", "hex8_iso_walk", "hex8_iso_transit",
                  ...
                  "hex8_pipeline", "hex8_context_pack", "hex8_mobility_pack"]
