# Plexis SGP — Checkpoint v4.10.0

**Generated:** 2026-06-10T11:46:23  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 34 (in catalog) · **Features:** 1007 (931 with curated descriptions)  
**Files indexed:** 245 · **Total size:** 303.9 MB
...
| `hex/hex8_all_features.parquet` | 2.4 |

---

_Checkpoint manifest: `CHECKPOINT_v4.10.0.json`. Atlas-1 backup: `plexis-sgp-v4.10.0.tar.gz`._