# Plexis SGP — Checkpoint v5.1.0

**Generated:** 2026-06-11T08:10:52  
**Pipeline total:** 228s = 3.8 min  
**Datasets:** 48 (in catalog) · **Features:** 2518 (1203 with curated descriptions)  
**Files indexed:** 250 · **Total size:** 305.3 MB
...
| `hex/hex8_all_features.parquet` | hex8 | 1,191 × 703 | all | MASTER — all standalone layers joined per hex-8 |
...
| `hex/hex9_embedding_where_64d.parquet` | 2.7 |
| `hex/hex8_all_features.parquet` | 2.5 |

---

_Checkpoint manifest: `CHECKPOINT_v5.1.0.json`. Atlas-1 backup: `plexis-sgp-v5.1.0.tar.gz`._